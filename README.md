...
with: `./build/quarkus-kotlin-sample-1.0-SNAPSHOT-runner`
...
- OptaPlanner ([guide](https://quarkus.io/guides/optaplanner)): Solve planning and scheduling with
  AI constraint optimization of vehicle routes, employee rosters, maintenance, tasks, lessons,
  conferences, ...
